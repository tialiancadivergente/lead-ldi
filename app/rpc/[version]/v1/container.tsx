...
export default function ContainerQuest({
  ...
  return (
    <div>
      <section
        className={`relative flex items-center justify-center overflow-hidden h-full bg-[url('/images/v1/bg-two.webp')] md:bg-[url('/images/v1/bg-two.webp')] bg-cover bg-center`}
      >
            ...
            <div className="w-full max-w-4xl mx-auto">
              <div className="mb-6 md:mb-8 flex justify-center">
                <Image
                  ...
                  height={178}
                  priority
                  className="object-contain select-none pointer-events-none h-auto mb-8"
                  style={{
                    maxWidth: "100%",
                    height: "auto",
                  }}
              ...
              <h1
                className={`text-2xl md:text-5xl font-bold text-white -mt-4 mb-1 md:mb-2 text-center`}
              >
                FALTA APENAS UM PASSO
              </h1>
              <h2
                className={`text-2xl md:text-5xl font-bold text-white mb-4 md:mb-7 text-center`}
              >
                PARA GARANTIR SUA VAGA!
              </h2>

              <p
                className="!text-[#FFFFFF] text-base md:text-lg mb-5 md:mb-7 text-center"
              >
