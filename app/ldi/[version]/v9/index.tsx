...
export default function Formv9() {
  ...
  useEffect(() => {
    ...
    const headlineParam = params?.headline;

    if (temperatureParam) {
      const temperaturaValue = normalizeTemperature(temperatureParam);
      const redLineVersion = String(headlineParam ?? "");
