  ...
  return (
    <section
      ...
      className="
        ...
        md:min-h-[842px]
        bg-[#071117]
        bg-[url('/images/v10/bg_segunda_dobra_mobile.webp')]
        md:bg-[url('/images/v10/bg_segunda_dobra_desktop.webp')]
        bg-[length:100%_100%]
        bg-center
        bg-no-repeat
        flex
    ...
    >
      <div className="w-full max-w-[1156px] mx-auto flex items-start justify-end">
        <div className="flex flex-col gap-4 md:gap-8 max-w-[517px] w-full md:mt-[-40px]">
          <h2
          ...
          <div className="mt-[25px] md:mt-0 w-full max-w-[350px] mx-auto flex flex-col gap-4 md:gap-8 md:max-w-[517px]">
