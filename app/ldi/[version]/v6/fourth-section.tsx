			...
			<div className="w-full max-w-[1156px] mx-auto flex items-start justify-end">
				<div className="flex flex-col gap-4 max-w-[517px] w-full">
					...
					<div className="mt-[400px] md:mt-0 w-full max-w-[350px] mx-auto flex flex-col gap-4 md:max-w-[517px]">
						...
						<p className="text-[#0A3740] font-mulish text-[16px] text-left leading-[135%] font-semibold">
						...
						<p className="text-[#0A3740] font-mulish text-[16px] text-left leading-[135%] font-semibold">
							Hoje, Ramon é casado, construiu uma nova história e tornou-se o primeiro brasileiro autorizado a aplicar a Teoria da Permissão. Com mais de 160 mil seguidores e passagens por emissoras como SBT, Band e Record, vem falando de algo que muita gente vive, mas quase ninguém sabe explicar: por que pessoas capazes continuam presas no quase?
						</p>
						...
						<button
							...
							className="mt-[12px] mb-[12px] w-full h-[64px] rounded-[8px] font-mulish font-extrabold text-[14px] md:text-[16px] leading-[145%] uppercase text-black transition-all hover:brightness-110 border border-[#FCF3D4] [background:linear-gradient(90deg,_#DFD2A7_0%,_#FCF3D4_100%)] shadow-[0px_6px_18.9px_0px_#F7EDCC85]"
						>
