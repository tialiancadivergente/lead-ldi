...
export default function HeroSection({
  ...
  return (
    <section
      id="hero"
      className="relative h-[1045px] md:min-h-[924px] md:h-[924px] flex flex-col justify-start overflow-hidden bg-[#071117] bg-[url('/images/v6/bg_hero_mobile.webp')] md:bg-[url('/images/v6/bg_hero_desktop.webp')] bg-cover bg-center px-4 pt-5 pb-6 md:p-0"
    >
