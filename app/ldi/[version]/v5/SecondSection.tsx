...
export default function SecondSection() {
	return (
		<section
			...
			`}
		>
			<div className="w-full max-w-[349px] md:max-w-[990px] mx-auto text-center py-10 font-mulish text-[16px] md:text-[18px] leading-[125%] text-[#0A3740] font-bold">
				...
				<div className="md:block hidden md:text-[40px] text-[20px] font-spectral font-bold text-[#0A3740] leading-[120%]">
				...
				<p className="text-[#0A3740] font-spectral text-[16px] md:text-[32px] leading-[125%] font-bold w-full my-10 md:hidden">
					Existem pessoas com <span className="text-[#C0964B] uppercase">menos condição que você</span>{" "}
					que conseguiram destravar a vida financeira e construir liberdade real. Elas não eram as mais preparadas.
				</p>
				<p className="text-[#0A3740] font-spectral text-[16px] md:text-[32px] leading-[125%] font-bold w-full">
