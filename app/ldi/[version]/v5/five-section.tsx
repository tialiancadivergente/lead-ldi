	...
	return (
		<section
			className="
				...
				md:min-h-[958px]
				bg-[#071117]
				bg-[url('/images//v5/bg_footer_mobile.webp')]
				md:bg-[url('/images/v5/bg_footer_desktop.webp')]
				bg-cover
				bg-center
				bg-no-repeat
				flex
		...
		>
			<div className="w-full md:max-w-[1024px] max-w-[350px] mx-auto flex flex-col items-center justify-center">
				<Image
					src="/images/v5/logo_footer_mobile.png"
					alt="Risk"
					width={300}
					height={85}
          className="w-full md:max-w-[350px] max-w-[250px] mx-auto"
				/>
				<p className="text-[#0A3740] font-spectral md:block hidden text-[20px] md:text-[25px] text-center leading-[125%] font-extrabold w-full max-w-[667px] mx-auto my-10">
					Não é sobre as pessoas mais talentosas. <br /> Não é sobre as mais preparadas.
				</p>
        <p className="text-[#0A3740] font-spectral md:hidden text-[20px] md:text-[25px] text-center leading-[125%] font-extrabold w-full max-w-[667px] mx-auto my-10">
					Não é sobre as pessoas mais talentosas. Não é sobre as mais preparadas.
				</p>
				<p className="text-[#0A3740] font-mulish text-[16px] md:text-[18px] text-center leading-[135%] font-semibold w-full max-w-[667px] mx-auto">
				...
				<div className="bg-transparent border-2 my-10 border-[#0A3740] text-[#0A3740] rounded-[16px] px-4 py-2 w-[353px] h-[71px] flex items-center justify-center gap-2">
					<Image
						src="/images/v5/video-on-fill.png"
						alt="Risk"
						width={42}
						height={42}
					/>
