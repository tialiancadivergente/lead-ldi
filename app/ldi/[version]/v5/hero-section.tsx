...
export default function HeroSection({
  ...
  return (
    <section
      id="hero"
      className="relative h-[1045px] md:min-h-[924px] md:h-[924px] flex flex-col justify-start overflow-hidden bg-[#071117] bg-[url('/images/v5/bg_mobile_hero.webp')] md:bg-[url('/images/v5/bg_desktop_hero.webp')] bg-cover bg-center px-4 pt-5 pb-6 md:p-0"
    >
      <div className="w-full max-w-[349px] md:max-w-[527px] flex flex-col items-center md:items-start text-left md:text-left mt-0 md:mt-[60px] md:ml-[100px] mx-auto md:mx-0">
        ...
        <div className="w-full flex justify-center md:hidden mb-6">
          <Image
            src="/images/v5/logo_mobile_hero.png"
            alt="Logo O Levante dos Improváveis"
            width={270}
            height={77}
          />
        ...
        >
          ...
          <span className="hidden md:block whitespace-nowrap">
            no mesmo lugar – mas agora está pronto para se levantar contra
          </span>
          <span className="hidden md:block whitespace-nowrap">
            os padrões que travam seu dinheiro, decisões e liberdade.
          </span>
        </p>

        <div className="w-full max-w-[400px] md:max-w-[527px] mt-10 md:mt-5">
          <LeadCaptureForm
            formName={formName}
            onSubmit={onSubmit}
            ...
            ddiSelectClassName="h-[52px] md:h-[64px] py-4 pl-[40px] pr-[28px] bg-[#FFFFFF26] backdrop-blur-[20px] rounded-l-[8px] border border-[#BDBCBC] border-r text-white font-mulish font-medium text-[16px] leading-[145%] focus:outline-none appearance-none"
