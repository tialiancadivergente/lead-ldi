  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="flex">
          <div className="h-[52px] md:h-[64px] px-3 flex items-center justify-center bg-[#FFFFFF26] backdrop-blur-[20px] rounded-l-[8px] border border-[#BDBCBC] border-r-0">
            <Phone size={18} className="text-[#02252C]" />
          </div>

          <select
            className={cn("rounded-l-none pl-[12px]", ddiSelectClassName)}
            style={{ fontFamily: "Arial, sans-serif" }}
            {...register("ddi")}
          >
