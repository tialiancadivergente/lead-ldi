	...
	return (
		<section
			className="
				...
				md:min-h-[916px]
				bg-[#071117]
				bg-[url('/images/v5/bg_fourth_mobile.webp')]
				md:bg-[url('/images/v5/bg_fourth_desktop.webp')]
				bg-cover
				bg-center
				bg-no-repeat
				flex
        ...
        justify-start
			...
			"
		>
			<div className="w-full max-w-[1156px] mx-auto flex items-start justify-end md:mt-[130px]">
				<div className="flex flex-col gap-4 max-w-[517px] w-full">
					<p className="text-[#0A3740] font-spectral text-[25px] md:text-[35px] text-center md:text-left leading-[125%] font-bold -mt-3 md:mt-0">
						QUEM VAI SER O SEU MENTOR NESSA JORNADA?
					</p>

					<div className="mt-[380px] md:mt-0 w-full max-w-[350px] mx-auto flex flex-col gap-4 md:max-w-[517px]">
						<p className="text-[#C0964B] font-spectral text-[30px] text-left leading-[125%] font-bold md:mt-0">
							Ramon Galimberti
						</p>

						{/* PARÁGRAFO 1 */}
						<p className="text-[#0A3740] font-mulish text-[12px] md:text-[12px] text-left leading-[135%] font-semibold">
						...
						<p className="text-[#0A3740] font-mulish text-[12px] md:text-[12px] text-left leading-[135%] font-semibold">
							...
							<span className="text-[#C0964B] font-extrabold">
						...
						{/* PARÁGRAFO 3 */}
						<p className="text-[#0A3740] font-mulish text-[12px] md:text-[12px] text-left leading-[135%] font-semibold">
							Hoje, Ramon é casado, construiu uma nova história, tornou-se o primeiro brasileiro autorizado a aplicar a Teoria da Permissão e tem mais de 160 mil pessoas acompanhando seu trabalho. Já foi convidado para compartilhar essa mensagem em emissoras como SBT, Band e Record porque fala de algo que muita gente vive, mas quase ninguém sabe explicar. No Levante dos Improváveis, Ramon conduz uma experiência para quem está cansado de repetir estagnação e quer entender o que realmente precisa ser corrigido para avançar.
						</p>
