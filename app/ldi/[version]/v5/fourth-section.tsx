...
export default function FourthSection() {
	return (
        ...
        justify-start
			...
			"
		>
			<div className="w-full max-w-[1156px] mx-auto flex items-start justify-end md:mt-[180px]">
				<div className="flex flex-col gap-4 max-w-[517px] w-full">
					...
					<div className="mt-[380px] md:mt-0 w-full max-w-[350px] mx-auto flex flex-col gap-4 md:max-w-[517px]">
						...
						{/* PARÁGRAFO 1 */}
						<p className="text-[#0A3740] font-mulish text-[12px] md:text-[14px] text-left leading-[135%] font-semibold">
