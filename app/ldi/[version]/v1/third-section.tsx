...
export default function ThirdSection() {
	return (
		<section
			...
			"
		>
			<div className="w-full max-w-[1090px] mx-auto py-10">
				<p className="text-[#F4F0E1] font-spectral text-[35px] text-center leading-[125%] font-bold max-w-[667px] w-full mx-auto my-6">
					O que elas fizeram de diferente?
				</p>
				<p className="text-[#F4F0E1] font-mulish text-[18px] text-center leading-[125%] font-semibold w-full max-w-[667px] mx-auto my-6">
				...
				<div className="flex items-center justify-center gap-1">
					<div className="bg-[url('/images/v1/frame.png')] bg-no-repeat bg-center bg-cover w-[270px] h-[290px]">
						<div className="flex items-center justify-center rounded-full font-bold font-spectral text-[32px] shadow-md mx-auto pt-10">
							<span
						...
						<div className="text-[#F4F0E1] font-mulish text-[18px] leading-[135%] font-semibold w-full px-8 mt-4">
				...
				<Image
					...
					width={609}
					height={2}
					className="w-full max-w-[609px] mx-auto my-16"
				/>
				<p className="text-[#C0964B] font-spectral text-[35px] text-center leading-[125%] font-bold max-w-[667px] w-full mx-auto">
				...
				<div className="flex items-center justify-center gap-1 mt-16">
					<div>
						<Image
							...
							height={31}
						/>
						<p className="text-[#F4F0E1] font-mulish text-[18px] leading-[135%] font-semibold w-full mt-4">
