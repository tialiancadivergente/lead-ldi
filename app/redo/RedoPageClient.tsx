...
function RedoPageContent({ initialSource }: RedoPageClientProps) {
  ...
  useEffect(() => {
    ...
    setTheme(theme);
    setRetrySource(resolveRetrySource(sourceParam || initialSource || temperature));
...
export default function RedoPageClient({ initialSource }: RedoPageClientProps) {
  return (
    <Suspense fallback={null}>
      <RedoPageContent initialSource={initialSource} />
    </Suspense>
  );
}
